...
function getColor(teamName) {
  if (teamName === 'Bengals') { return 0xFB4F14; }
  else if (teamName === 'Browns') { return 0xFF3C00; }
  else if (teamName === 'Bulls') {return 0x000e7a; }
  else if (teamName === 'Crusaders') { return 0xf5f50f; }
  else if (teamName === 'Elks') { return 0x2d5feb; }
  else if (teamName === 'Huskies') { return 0x2d9feb; }
  return 0x000000;
}